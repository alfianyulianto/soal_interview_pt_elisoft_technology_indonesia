...
<head>
  ...
  <!-- icheck bootstrap -->
  <link rel="stylesheet" href="{{ url('') }}/tamplates/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
  <!-- Theme style -->
...
<body class="hold-transition login-page">
  <div class="login-box">
    ...
    <div class="card card-outline card-primary">
      <div class="card-header text-center">
        <a href="{{ url('') }}/tamplates/index2.html" class="h1"><b>Admin</b>LTE</a>
      </div>
      <div class="card-body">
  ...
  <!-- AdminLTE App -->
  <script src="{{ url('') }}/tamplates/dist/js/adminlte.min.js"></script>
</body>
